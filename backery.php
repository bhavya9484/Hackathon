<div style="border: 4px solid black; width: 100%: padding: 1px;">
          <marquee behavior="alternate"­><h2 style="color: black; font-family: cursive; font-size: 40px;padding-top: 6px;padding-bottom: 0px;margin-bottom: 1px;">Bakerys</h2></marquee>
     </div><br>
  ...
  <div class="card mb-3">
    <div class="card-body">
      <form method="post" action="index.php?action=add&id=<?php echo $row["product_code"]; ?>">
         ...
         <h5 class="text-info">Available Qty:(<?php echo $row["total_product"]; ?>)</h5>
